...
import { postActorsAPI } from '../APIS/API';
import { getActors } from '../action/actors';
import { useDispatch } from "react-redux";


export default function ActorPopup() {
  ...
  const ActorPopupfarmik = useFormik({
    initialValues: {
      name: '',
      gender: '',
      dob: '',
    ...
    onSubmit: async values => {
      try {
        const respon = await postActorsAPI(values)
        console.log(respon)
        dispatch(getActors())
      } catch (error) {
        console.log(error)
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full  items-center justify-center p-4 text-center">
              ...
              >
                ...
                <div className="w-[80%]">
                <h1 className="text-[#000] text-[30px] font-medium">Add new actor</h1>
                <p className="text-[#000] text-[20px] opacity-[0.50]">This week's top TV and movies</p>
                </div>


            <form onSubmit={ActorPopupfarmik.handleSubmit} > 
            ...
            <input
              ...
              onChange={ActorPopupfarmik.handleChange}
              value={ActorPopupfarmik.values.name}
          ...
          <div className='grid grid-cols-1 pt-[1em]'>
            ...
            <div className='flex items-center gap-[4px] '>
                ...
                type='radio'
                // value='male'
                onChange={(event)=>ActorPopupfarmik.setFieldValue('gender','Male')}
                value={ActorPopupfarmik.values.gender}
                className=" mx-[7px]" 
                />
                ...
                type='radio'
                // value='Female'
                onChange={(event)=> ActorPopupfarmik.setFieldValue('gender','Female')}
                value={ActorPopupfarmik.values.gender} 
                className=" mx-[7px]" 
                />
          ...
          <div className='grid grid-cols-1'>
            ...
            <input
              ...
              onChange={ActorPopupfarmik.handleChange}
              value={ActorPopupfarmik.values.dob}
              className="font-medium text-[15px] h-[50px] py-[10px] px-[20px] rounded-[5px]
            bg-[#ffffff1f] border-[#0000002e] text-[#000] border-2 focus:border-[#000] focus:outline-none"
            />
          </div>
          ...
          <div className='grid grid-cols-1'>
            ...
            <textarea
              ...
              onChange={ActorPopupfarmik.handleChange}
              value={ActorPopupfarmik.values.bio}
              rows="6" 
